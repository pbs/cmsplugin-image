...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImageCrop.variable_id'
        db.delete_column('image_crop', 'variable_id_id')

        # Adding field 'ImageCrop.variable'
        db.add_column('image_crop', 'variable',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smartsnippets.Variable']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImageCrop.variable_id'
        db.add_column('image_crop', 'variable_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smartsnippets.SmartSnippetVariable']),
                      keep_default=False)

        # Deleting field 'ImageCrop.variable'
        db.delete_column('image_crop', 'variable_id')
